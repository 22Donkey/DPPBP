...
from util.prelabel import read_and_convert_to_tensor
import numpy as np
import torch
...
def caculate_metric(pred_y, labels, pred_prob):
    ...
    file_path = '/data2024/yyyl/code/PepBCL-master/test/test2_3.txt'
    pred_y = read_and_convert_to_tensor(file_path, pred_y)
